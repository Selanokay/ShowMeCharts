...
app.get('/api/parse-json', async (req, res) => {
    try {
        // Read JSON file
        const jsonData = fs.readFileSync('/Users/grr16/Pictures/Capstone-Folder/Capstone-3.0/Capstone/Capstone/Backend/backend/parsing/StreamingHistory_music_0.json', 'utf8') 
